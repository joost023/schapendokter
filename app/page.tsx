          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full lg:w-auto">
              ...
              <Image
                ...
                width={140}
                height={40}
                className="h-5 sm:h-6 md:h-8 w-auto opacity-80"
              />
            </div>
            <div className="text-center lg:text-right">
              <p className="text-sm sm:text-base md:text-lg mt-1 text-muted-foreground">Adviestraject 2025</p>
            </div>
          </div>
        </div>
      </header>
            ...
            <section>
              <Card className="border-border" style={{ backgroundColor: "#fffbef" }}>
                ...
                <CardContent className="space-y-4 p-4 md:p-6">
                  ...
                  <div className="bg-blue-50 rounded-lg p-4 md:p-6 my-4 md:my-6 border border-blue-200">
                    <h3 className="font-semibold text-blue-900 mb-3 text-base md:text-lg">
            ...
            <section>
              <Card className="border-2 border-primary" style={{ backgroundColor: "#fffbef" }}>
                ...
                <CardContent className="space-y-4 pt-4 md:pt-6 p-4 md:p-6">
                  ...
                  <div className="bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg p-4 md:p-6 border-2 border-primary/20 mt-6">
            ...
            <section>
              <Card className="bg-primary text-primary-foreground border-0">
                ...
                <CardContent className="text-center space-y-4 md:space-y-6 p-4 md:p-6">
                  ...
                  <div className="bg-slate-100 rounded-lg p-4 md:p-6 text-left border border-slate-200">
                    <h4 className="font-semibold mb-3 text-base md:text-lg text-slate-900">Aanvullende begeleiding:</h4>
